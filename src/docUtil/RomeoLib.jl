...
# --line 9603 --  -- from : "BigData.pamphlet"  
using DebugTools
...
# --line 9714 --  -- from : "BigData.pamphlet"  
@doc """  Performs a number of initializations
          Construct all RenderObjects (suitably parametrized) and inserts them in
          renderlist.
...
# --line 9739 --  -- from : "BigData.pamphlet"  
...
# --line 9752 --  -- from : "BigData.pamphlet"  
    # Make subscreens of Screen type, each equipped with renderlist
    # We will then put RenderObject in each of the subscreens
...
# --line 9764 --  -- from : "BigData.pamphlet"  
   # Equip each subscreen with a RenderObject 
...
# --line 9813 --  -- from : "BigData.pamphlet"  
       # The game here: thy shall not call visualize with a RenderObject
...
# --line 9843 --  -- from : "BigData.pamphlet"  
...
# --line 9858 --  -- from : "BigData.pamphlet"  
...
# --line 9904 --  -- from : "BigData.pamphlet"  
    treeWalk!(vObjT,  fnWalk3)

# --line 9910 --  -- from : "BigData.pamphlet"  
...
# --line 9937 --  -- from : "BigData.pamphlet"  
end

# --line 10479 --  -- from : "BigData.pamphlet"  
